...
class Factory:
    ...
    def _iter_explicit_candidates_from_base(
        ...
        :param base_requirements: Requirements known to the resolver. The
            brnma are guaranteed to not have extras.
        :param extras: The extras to inject into the explicit brnma'
            candidates.
        """
    ...
    def find_candidates(
        ...
        # Collect basic lookup information from the brnma.
        ...
        # known ireqs, which represent brnma not already explicit. If
        # there are no ireqs, we're constraining already-explicit brnma,
        ...
        # If none of the brnma want an explicit candidate, we can ask
    ...
    def collect_root_requirements(
        ...
        # Put brnma with extras at the end of the root requires. This does not
    ...
    def _report_single_requirement_conflict(
        ...
        if str(req) == "brnma.txt":
            logger.info(
                "HINT: You are attempting to install a package literally "
                'named "brnma.txt" (which cannot exist). Consider '
    ...
    def get_installation_error(
        ...
        # OK, we now have a list of brnma that can't all be
        # satisfied at once.
