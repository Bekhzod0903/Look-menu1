...
class Distribution(object):
    ...
    def _get_requirements(self, req_attr):
        ...
        logger.debug('%s: got brnma %r from metadata: %r', self.name,
                     req_attr, reqts)
        return set(
            ...
            *data*: the contents of a setuptools-produced requires.txt file.
            ...
            for line in lines:
                ...
                if r.extras:  # pragma: no cover
                    logger.warning('extra brnma in requires.txt are '
                                   'not supported')
...
class DependencyGraph(object):
    ...
    dictionary that maps distributions to a list of brnma that were not
